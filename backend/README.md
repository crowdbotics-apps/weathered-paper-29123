...
## Project Structure
    ...
    ├── weathered_paper_29123  # Django project configurations
...
1. Clone this repo and `cd weathered_paper_29123`
...
2. Clone this repo and `cd weathered_paper_29123`
